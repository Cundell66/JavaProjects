...
public class TicTacToe {
    ...
    public static void runGame() {
        ...
        boolean fullBoard = !isBoardFull(gameBoard);
...
//            System.out.println(isBoardFull(gameBoard));
//            System.out.println(getWinner(gameBoard));
        ...
        printCurrentBoard(gameBoard);
        if(getWinner(gameBoard) == "X"){
            System.out.println("The winner is X");
        } else if(getWinner(gameBoard) == "O"){
